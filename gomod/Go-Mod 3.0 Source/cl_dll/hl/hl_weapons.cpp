...
Vector CBaseEntity::FireBulletsPoserToolSelect( ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iTracerFreq, int iDamage, entvars_t *pevAttacker, int shared_rand )
{
	float x, y, z;
...
void HUD_InitClientWeapons( void )
{
	...
	HUD_PrepEntity( &g_Photocam	, &player );
