...
void EV_Photocam( struct event_args_s *args );
...
void EV_FireGRAPPLE( struct event_args_s *args ); //GRAPPLE WEAPON
...
void Game_HookEvents( void )
{
	...
	gEngfuncs.pfnHookEvent( "events/photocam.sc",				EV_Photocam );
	...
	gEngfuncs.pfnHookEvent( "events/grapple.sc",				EV_FireGRAPPLE );//WEAPON GRAPPLE
}
